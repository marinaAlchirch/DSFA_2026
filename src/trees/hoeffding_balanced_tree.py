...
def HAT(max_byte_size=33554432, memory_estimate_period=1000000, grace_period=200,
    ...
    return HoeffdingBalancedTreeClassifier(max_byte_size=max_byte_size,
...
class HoeffdingAdaptiveTreeClassifier(HoeffdingTreeClassifier):
    ...
    Examples
    --------
    >>> from src.trees import HoeffdingAdaptiveTreeClassifier
    >>> from src.data import ConceptDriftStream
