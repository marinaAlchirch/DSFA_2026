"""
The :mod:`src.trees` module includes learning methods based on trees.
"""
...
from .hoeffding_balanced_tree_regressor import HoeffdingBalancedTreeRegressor
...
from .arf_hoeffding_tree import ARFHoeffdingTreeClassifier
from .arf_hoeffding_tree_regressor import ARFHoeffdingTreeRegressor

__all__ = ["HoeffdingTreeClassifier", "HoeffdingAdaptiveTreeClassifier",
           "ExtremelyFastDecisionTreeClassifier", "LabelCombinationHoeffdingTreeClassifier", "ARFHoeffdingTreeClassifier",
           "HoeffdingTreeRegressor", "HoeffdingAdaptiveTreeRegressor", "HoeffdingBalancedTreeRegressor", "iSOUPTreeRegressor",
           "StackedSingleTargetHoeffdingTreeRegressor",
           # TODO remove in v0.7.0
           "HoeffdingTree", "HAT", "HATT", "LCHT", "RegressionHoeffdingTree",
           "RegressionHAT", "ARFHoeffdingTreeRegressor", "MultiTargetRegressionHoeffdingTree",
           ]
