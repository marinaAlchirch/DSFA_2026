...
class WindowMajorityClasses(SlidingWindow):
    """Marina note : keep a window that keeps the statistics of examples that belong to majority classes"""
...
class WindowMinorityClasses(SlidingWindow):
    """Marina note : keep a window that keeps the statistics of examples that belong to minority classes"""
