...
from src.evaluation.base_evaluator import StreamEvaluator
from src.utils import constants
from src.data import TimeManager
...
class EvaluatePrequentialDelayed(StreamEvaluator):
    ...
    >>> import numpy as np
    >>> import pandas as pd
    >>> from src.data import TemporalDataStream
    >>> from src.trees import HoeffdingTreeClassifier
    >>> from src.evaluation import EvaluatePrequentialDelayed
    >>>
