...
class EvaluateStreamGenerationSpeed(object):
    ...
    Examples
    --------
    >>> from src.data.random_rbf_generator_drift import RandomRBFGeneratorDrift
    >>> from src.evaluation.evaluate_stream_gen_speed import EvaluateStreamGenerationSpeed
