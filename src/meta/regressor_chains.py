...
from src.core import BaseSKMObject, RegressorMixin, MetaEstimatorMixin, MultiOutputMixin
...
class RegressorChain(BaseSKMObject, RegressorMixin, MetaEstimatorMixin, MultiOutputMixin):
    ...
    --------
    >>> from sklearn.linear_model import SGDRegressor
    >>> from src.meta import RegressorChain
    >>> from src.data import make_logical
    >>>
