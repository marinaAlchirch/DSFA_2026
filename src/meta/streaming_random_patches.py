...
from src.core import BaseSKMObject, ClassifierMixin, MetaEstimatorMixin, clone
...
from src.utils import check_random_state, get_dimensions
...
class StreamingRandomPatchesClassifier(BaseSKMObject, ClassifierMixin, MetaEstimatorMixin):
    ...
    Examples
    --------
    >>> from src.data import AGRAWALGenerator
    >>> from src.meta import StreamingRandomPatchesClassifier
    >>>
