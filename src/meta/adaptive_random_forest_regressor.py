...
from src.core import BaseSKMObject, RegressorMixin
from src.meta import AdaptiveRandomForestClassifier
from src.drift_detection.base_drift_detector import BaseDriftDetector
from src.drift_detection import ADWIN
from src.trees.arf_hoeffding_tree_regressor import ARFHoeffdingTreeRegressor
from src.metrics.measure_collection import RegressionMeasurements
from src.utils import get_dimensions, check_random_state
...
class AdaptiveRandomForestRegressor(RegressorMixin, AdaptiveRandomForestClassifier):
    ...
    >>> from src.meta import AdaptiveRandomForestRegressor
    >>> import numpy as np
    >>>
    >>> # Setup a data stream
