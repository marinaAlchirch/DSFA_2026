...
from src.core import BaseSKMObject, ClassifierMixin, MetaEstimatorMixin, MultiOutputMixin
...
class MultiOutputLearner(BaseSKMObject, ClassifierMixin, MetaEstimatorMixin, MultiOutputMixin):
    ...
    Examples
    --------
    >>> from src.meta.multi_output_learner import MultiOutputLearner
    >>> from src.data.file_stream import FileStream
